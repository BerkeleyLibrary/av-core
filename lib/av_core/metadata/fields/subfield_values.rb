  ...
  module Metadata
    module Fields
      ...
      class SubfieldValues
        ...
        # Iterates over the array of hashes returned by {SubfieldValues#by_index}
        # @see #by_index
        ...
        # @return [SubfieldValues] the reordered values
        def ordered_by(subfield_order)
          ...
          SubfieldValues.new(by_code_ordered)
        end
        ...
        class << self
          ...
          # @return [SubfieldValues] the grouped values
          def from_data_field(data_field)
